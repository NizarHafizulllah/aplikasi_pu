      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-home"></i> <span>Properti</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url('properti'); ?>"><i class="fa fa-eye"></i> Lihat Data</a></li>
                <li><a href="<?php echo site_url('properti/baru'); ?>"><i class="fa fa-user-plus"></i> Tambah Data</a></li>
                <li><a href="<?php echo site_url('properti/import'); ?>"><i class="fa fa-file-excel-o"></i> Import Data</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
